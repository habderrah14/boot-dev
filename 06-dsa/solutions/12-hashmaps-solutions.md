# Module 06 · Chapter 12 Solutions — Hashmaps
...
**Concrete angles for `Hashmaps`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
