# Module 04 · Chapter 04 Solutions — Abstraction
...
**Concrete angles for `Abstraction`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
