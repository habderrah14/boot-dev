# Module 05 · Chapter 06 Solutions — Closures
...
**Concrete angles for `Closures`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
