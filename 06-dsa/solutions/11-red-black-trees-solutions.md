# Module 06 · Chapter 11 Solutions — Red-Black Trees
...
**Concrete angles for `Red-Black Trees`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
