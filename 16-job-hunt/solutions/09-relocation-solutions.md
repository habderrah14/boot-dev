# Module 16 · Chapter 09 Solutions — Relocation
...
**Concrete angles for `Relocation`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
