# Module 06 · Chapter 07 Solutions — Stacks
...
**Concrete angles for `Stacks`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
