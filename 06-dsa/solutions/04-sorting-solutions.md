# Module 06 · Chapter 04 Solutions — Sorting Algorithms
...
**Concrete angles for `Sorting Algorithms`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
