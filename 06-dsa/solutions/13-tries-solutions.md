# Module 06 · Chapter 13 Solutions — Tries
...
**Concrete angles for `Tries`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
