# Module 05 · Chapter 07 Solutions — Currying
...
**Concrete angles for `Currying`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
