# Module 14 · Chapter 06 Solutions — Dockerfiles
...
**Typical patterns for Docker and OCI containers:**
...
**Concrete angles for `Dockerfiles`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
