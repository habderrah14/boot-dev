# Module 05 · Chapter 03 Solutions — Pure Functions
...
**Concrete angles for `Pure Functions`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
