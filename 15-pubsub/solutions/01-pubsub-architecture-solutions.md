# Module 15 · Chapter 01 Solutions — Pub/Sub Architecture
...
**Concrete angles for `Pub/Sub Architecture`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
