# Module 07 · Chapter 01 Solutions — C Basics
...
**Concrete angles for `C Basics`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
