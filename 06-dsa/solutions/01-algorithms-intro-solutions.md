# Module 06 · Chapter 01 Solutions — Algorithms Intro
...
**Concrete angles for `Algorithms Intro`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
