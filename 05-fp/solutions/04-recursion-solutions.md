# Module 05 · Chapter 04 Solutions — Recursion
...
**Concrete angles for `Recursion`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
