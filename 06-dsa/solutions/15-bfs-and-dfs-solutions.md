# Module 06 · Chapter 15 Solutions — BFS and DFS
...
**Concrete angles for `BFS and DFS`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
