# Module 05 · Chapter 09 Solutions — Sum Types
...
**Concrete angles for `Sum Types`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
