...
Write short answers for 5 key terms from **Scope** and one tiny code snippet that uses the core idea correctly.

**Success check:** Your snippet runs and your definitions are in your own words.

## L2 — Guided coding

Build one guided artifact from the chapter in `practice/04-scope/`.
...
After finishing L1–L4, update **Checkpoint C** in:
