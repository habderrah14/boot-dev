# Module 13 · Chapter 03 Solutions — AWS S3
...
**Concrete angles for `AWS S3`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
