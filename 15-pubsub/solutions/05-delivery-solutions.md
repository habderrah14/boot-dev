# Module 15 · Chapter 05 Solutions — Delivery
...
**Concrete angles for `Delivery`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
