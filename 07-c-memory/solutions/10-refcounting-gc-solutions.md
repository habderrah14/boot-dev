# Module 07 · Chapter 10 Solutions — Reference Counting GC
...
**Concrete angles for `Reference Counting GC`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
