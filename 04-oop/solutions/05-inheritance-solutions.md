# Module 04 · Chapter 05 Solutions — Inheritance
...
**Concrete angles for `Inheritance`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
