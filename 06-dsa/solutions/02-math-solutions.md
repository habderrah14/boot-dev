# Module 06 · Chapter 02 Solutions — Math for Algorithms
...
**Concrete angles for `Math for Algorithms`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
