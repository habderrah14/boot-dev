# Module 14 · Chapter 02 Solutions — Containers
...
**Concrete angles for `Containers`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
