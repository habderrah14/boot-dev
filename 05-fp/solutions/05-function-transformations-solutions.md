# Module 05 · Chapter 05 Solutions — Function Transformations
...
**Concrete angles for `Function Transformations`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
