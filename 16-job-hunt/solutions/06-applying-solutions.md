# Module 16 · Chapter 06 Solutions — Applying
...
**Concrete angles for `Applying`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
