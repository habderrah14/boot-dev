# Module 15 · Chapter 07 Solutions — Scalability
...
**Concrete angles for `Scalability`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
