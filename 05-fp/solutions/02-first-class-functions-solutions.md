# Module 05 · Chapter 02 Solutions — First-Class Functions
...
**Concrete angles for `First-Class Functions`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
