# Module 15 · Chapter 04 Solutions — Subscribers and Routing
...
**Typical patterns for RabbitMQ-style pub/sub in TypeScript:**
...
**Concrete angles for `Subscribers and Routing`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
