# Module 07 · Chapter 06 Solutions — Stack and Heap
...
**Concrete angles for `Stack and Heap`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
