# Module 16 · Chapter 03 Solutions — GitHub Profile
...
**Concrete angles for `GitHub Profile`:** cost of round-trips, blast radius of misconfiguration, observability coverage, migration pain, vendor lock-in.
